        ...
        text: [
          "At Magura, we specialize in pairing exceptional properties with exceptional people. Our focus is on creating a seamless, worry - free experience for both landlords and our clients.By placing working professionals in meticulously managed homes, we provide a win- win solution: ",
          {
            bulletPoints: [
              ...
              "For tenants, we offer not just a place to stay, but a space that feels like home—equipped with modern comforts and a touch of personalised luxury.",
            ],
          },
  ...
  return (
    <div>
      ...
      <p className="text-paragraph text-2xl">
        Magura was born out of a simple yet powerful vision: to bridge the gap between landlords seeking reliable tenants and travelling professionals in need of a truly comfortable home
        away from home. Founded in the heart of London, our company was inspired by the city’s
        dynamic lifestyle and the unique demands of its high-achieving residents and visitors.
      </p>
